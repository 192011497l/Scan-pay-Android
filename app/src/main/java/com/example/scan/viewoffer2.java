...
public class viewoffer2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewoffer2);
...
//                Intent intent = new Intent(viewoffer2.this, insertoffer.class);
...
//        });
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(viewoffer2.this, ProfileActivity.class);
                startActivity(intent);
            }
        });
        ...
        homeIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle the click event, e.g., start the ProfileActivity
                Intent intent = new Intent(viewoffer2.this, custmerhome.class);
                startActivity(intent);
            }
        });
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle the click event, e.g., start the ProfileActivity
                Intent intent = new Intent(viewoffer2.this, viewcart.class);
                startActivity(intent);
            }
        });
    }
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!snapshot.exists()) {
                    ...
                    TextView noOffersTextView = new TextView(viewoffer2.this);
                ...
                for (DataSnapshot coversSnapshot : snapshot.getChildren()) {
                    ...
                    View coverItemView = getLayoutInflater().inflate(R.layout.itemoffer2, coversContainer, false);
